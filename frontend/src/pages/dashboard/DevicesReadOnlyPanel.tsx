    ...
    return (
      <div className="space-y-5">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Read-only endpoint inventory from Wazuh SIEM</p>
        </div>
        <div className="rounded-2xl bg-slate-900 border border-slate-800 p-10 text-center">
          ...
          <p className="text-xs text-slate-500 mt-1">Ask your administrator to connect it under Settings → Wazuh SIEM.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="p-4 rounded-xl bg-red-500/5 border border-red-500/20">
          ...
          <p className="text-xs text-slate-400 mt-0.5">Disconnected</p>
        </div>
      </div>
